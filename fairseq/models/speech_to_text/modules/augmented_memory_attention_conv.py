...
class AugmentedMemoryConvTransformerEncoder_conv(ConvTransformerEncoder):
    ...
    def forward(self, x, src_lengths, states=None):
...
#   SequenceEncoder
# ------------------------------------------------------------------------------
class SequenceEncoder_conv(ConvTransformerEncoder):
    """
...
# ------------------------------------------------------------------------------
def augmented_memory_conv(klass):
